...
desc[['Moves_mean']].plot(kind='bar', figsize=(10, 6))
plt.title('Comparação de Média de Movimentos por Algoritmo')
plt.ylabel('Número de movimentos')
plt.xlabel('Algoritmo')
plt.xticks(rotation=45)
plt.legend(['Média de Movimentos'])
plt.tight_layout()
plt.show()

# Gráfico de barras para times_mean sem BFS
desc_sem_bfs = desc.drop(index='BFS', errors='ignore')
desc_sem_bfs[['Time_mean']].plot(kind='bar', figsize=(10, 6))
plt.title('Comparação de Média de Tempo por Algoritmo (Sem BFS)')
plt.ylabel('Tempo (s)')
plt.xlabel('Algoritmo')
plt.xticks(rotation=45)
plt.legend(['Média de Movimentos'])
...
# Gráfico de barras para Time_mean
desc[['Time_mean']].plot(kind='bar', figsize=(10, 6))
plt.title('Comparação de Média de Tempo por Algoritmo')
plt.ylabel('Tempo (s)')
plt.xlabel('Algoritmo')
plt.xticks(rotation=45)
plt.legend(['Média de Tempo'])
plt.tight_layout()
plt.show()
